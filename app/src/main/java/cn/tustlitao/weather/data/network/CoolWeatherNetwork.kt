package cn.tustlitao.weather.data.network

import cn.tustlitao.weather.data.network.api.PlaceService
import cn.tustlitao.weather.data.network.api.WeatherService
...
class CoolWeatherNetwork {
    ...
    companion object {
        ...
        val instance: CoolWeatherNetwork
            get() {
            if (network == null) {
