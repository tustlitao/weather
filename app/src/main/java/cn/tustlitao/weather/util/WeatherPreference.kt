package cn.tustlitao.weather.util
...
class WeatherPreference<T>(private val keyName: String, private val default: T) {

    private val prefs: SharedPreferences by lazy { WeatherApplication.context.getSharedPreferences(keyName, Context.MODE_PRIVATE) }
