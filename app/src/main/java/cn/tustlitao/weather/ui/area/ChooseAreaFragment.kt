...
import cn.tustlitao.weather.databinding.ChooseAreaBinding
import cn.tustlitao.weather.di.Injectable
...
class ChooseAreaFragment : Fragment(), Injectable {

    @Inject
    lateinit var viewModelFactory: ViewModelProvider.Factory

    private val viewModel by lazy { ViewModelProviders.of(this, viewModelFactory).get(ChooseAreaViewModel::class.java) }
